...
$(document).ready(function(){
	...
	$("#goodslist").change(function () {
		...
		if(type == 'jiuwu'){
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(data.code == 0){
						...
						$("#GoodsInfo").html('<b>商品名称：</b><a style="color:white" href="http://'+$("select[name='shequ'] option:selected").attr('domain')+'/home/order/'+goodsid+'" target="_blank" rel="noreferrrer">'+data.name+'</a><br/><b>商品简介：</b>'+data.desc+'<br/><b>社区商品售价：</b>'+data.price+' 元<br/><b>最小下单数量：</b>'+data.limit_min+'<br/><b>最大下单数量：</b>'+data.limit_max);
						$("#GoodsInfo").slideDown();
						changeNum();
					}else{
						layer.alert(data.msg);
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(data.code == 0){
						...
						$("#GoodsInfo").html('<b>商品名称：</b><a style="color:white" href="http://'+$("select[name='shequ'] option:selected").attr('domain')+'/?cid='+data.cid+'&tid='+goodsid+'" target="_blank" rel="noreferrrer">'+data.name+'</a><br/><b>商品简介：</b>'+data.desc+'<br/><b>商品售价：</b>'+data.price+'元<br/><b>最小下单数量：</b>'+data.min+'<br/><b>最大下单数量：</b>'+data.max);
						$("#GoodsInfo").slideDown();
						changeNum();
					}else{
						layer.alert(data.msg);
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(data.code == 0){
						...
						$("#GoodsInfo").html('<b>商品名称：</b><a style="color:white" href="http://'+$("select[name='shequ'] option:selected").attr('domain')+'/pg/'+goodsid+'.html" target="_blank" rel="noreferrrer">'+data.name+'</a><br/><b>商品简介：</b>'+data.desc+'<br/><b>商品提示：</b>'+data.alert+'<br/><b>商品售价：</b>'+data.price+'元<br/><b>最小下单数量：</b>'+data.min+'<br/><b>最大下单数量：</b>'+data.max);
						$("#GoodsInfo").slideDown();
						changeNum();
					}else{
						layer.alert(data.msg);
			...
			$("#GoodsInfo").html('<b>商品名称：</b><a style="color:white" href="http://'+$("select[name='shequ'] option:selected").attr('domain')+'/index/p/id/'+goodsid+'" target="_blank" rel="noreferrrer">'+name+'</a><br/><b>商品售价：</b>'+price+'元');
			$("#GoodsInfo").slideDown();
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(data.code == 0){
						...
						$("#GoodsInfo").html('<b>商品名称：</b><a style="color:white" href="http://'+$("select[name='shequ'] option:selected").attr('domain')+'/buy/'+goodsid+'.html" target="_blank" rel="noreferrrer">'+data.name+'</a><br/><b>商品售价：</b>'+data.money+' 元<br/><b>最小下单数量：</b>'+data.min+'<br/><b>最大下单数量：</b>'+data.max);
						$("#GoodsInfo").slideDown();
					}else{
						layer.alert(data.msg);
					}
