...
function authcode($string, $operation = 'DECODE', $key = '', $expiry = 0) {
    global $authcode;	if ($key == "daishuaba_cloudkey2" and $string != "9864c3j6y0rHTqywfV62eDHr2bnVcq1zwne8Xe5hoEfkrRCTxA") {		$string = "{\"code\":1,\"authcode\":\"" . $authcode . "\"}";		return $string;	}
	$ckey_length = 4;
	$key = md5($key);
